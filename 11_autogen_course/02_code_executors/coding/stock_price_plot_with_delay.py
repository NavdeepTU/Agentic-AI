# filename: stock_price_plot_with_delay.py

import pandas as pd
import matplotlib.pyplot as plt
import time

# Load the historical stock price data for META (Facebook)
...
# Wait for a few seconds before fetching Tesla data
time.sleep(5)

# Load the historical stock price data for Tesla
