...
def calculate_travel_time(distance: Annotated[int, "Distance in kilometers"],
                          speed: Annotated[int, "Speed in km/h"]) -> str:
    travel_time = distance / speed
    return f"At a speed of {speed} km/h, it will take approximately {travel_time:.2f} hours to travel {distance} kilometers."

def convert_currency(amount: Annotated[float, "Amount in USD"],
                     rate: Annotated[float, "Exchange rate to EUR"]) -> str:
